...
2. Download the **sample CSV template** (optional but helpful)
3. Fill in your user details in Excel or a text editor
4. Upload your completed CSV file and submit the import

### 📄 Example CSV Format

```csv
UserPrincipalName,DisplayName,FirstName,LastName,JobTitle,Department
john.doe@idsentinelsolutions.com,John Doe,John,Doe,Security Analyst,IT
jane.smith@idsentinelsolutions.com,Jane Smith,Jane,Smith,IT Support,Helpdesk
```
...
📸 Screenshot:  
`entra/screenshots/bulk-upload.png` *(upload when available)*
📁 [Download Sample CSV](./scripts/bulk_users.csv)
